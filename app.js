...
const stages = require('./routes/admin/stages');
const categories = require('./routes/admin/categories');
const ventureCategories = require('./routes/admin/ventureCategories');
...
app.use('/admin/stages', stages);
app.use('/admin/categories', categories);
app.use('/admin/venture-categories', ventureCategories);
